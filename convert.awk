...
BEGIN {
    while (getXML(ARGV[1],0)) {
        if (XTYPE == "DAT") {
            ...
            if (XITEM == "p") print ".LP"
            else if (XITEM == "blockquote") print ".QS"
            else if (XITEM == "title") print ".TL"
            else if (XITEM == "strong" || XITEM == "var" ||
		     XITEM == "code") print ".B"
            else if (XITEM == "ul") print ".RS"
            else if (XITEM == "li") print ".IP"
            else if (XITEM == "code") print 
	    else if (XITEM == "h3") print ".SH"
	    else if (XITEM == "em") print ".I"
	    else if (XITEM == "pre") print ".LP"
	    else if (XITEM == "a" || XITEM == "head" || XITEM == "body") ;
	    else print XTYPE, XITEM	    
        } else if (XTYPE == "END") {
            if (XITEM == "blockquote") print ".QE"
            else if (XITEM == "strong" || XITEM == "var" ||
		     XITEM == "code" || XITEM == "em") print ".R"
            else if (XITEM == "ul") print ".RE"
	    else if (XITEM == "a" || XITEM == "p" || XITEM == "body" ||
		     XITEM == "html" || XITEM == "h3" || XITEM == "li" ||
		     XITEM == "head" || XITEM == "body" ||
		     XITEM == "title" || XITEM == "pre") ;
	    else print XTYPE, XITEM	    
        }
    }
    if (XERROR) {
